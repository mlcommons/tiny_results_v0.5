...
if { $::argc == 1 } {
    ...
    createapp -name $accname\_fsbl -app {Zynq FSBL} -proc ps7_cortexa9_0 -hwproject $accname\_platform -os standalone
    configapp -app $accname\_standalone -add libraries {m}
}
