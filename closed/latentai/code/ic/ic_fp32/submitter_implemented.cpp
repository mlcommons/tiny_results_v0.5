...
string model_path = "bin/ic_fp32.so";
...
void th_load_tensor() {
  ...
  float input_asfloat[kIcInputSize];
  ...
  uint16_t i = 0;
  for(i=0; i<kIcInputSize;i++) { input_asfloat[i] = (float) input_pixels[i]; }
